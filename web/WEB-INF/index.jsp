<%-- 
    Document   : index
    Created on : 22/09/2020, 19:40:00
    Author     : HERBER 
--%>
        ...
        <div class="modal-body">
            <form action="productos" method="post" class="form-group">
               <label for="id" ><b>ID</b></label>
                ...
                <label for="precio_costo" ><b>Precio_Costo</b></label>
                <input type="number" name="txt_precio_costo" id="txt_precio_costo" class="form-control"  required>
                <label for="precio_venta" ><b>Precio_Venta</b></label>
                ...
                <br>
                <button name="agregar" id="btn_agregar"  value="agregar" class="btn btn-primary btn-lg">Agregar</button>
                <button name="modificar" id="btn_modificar"  value="modificar" class="btn btn-success btn-lg">Modificar</button>
                <button name="eliminar" id="btn_eliminar"  value="eliminar" class="btn btn-danger btn-lg" onclick="javascript:if(!confirm('¿Desea Eliminar?'))return false" >Eliminar</button>
