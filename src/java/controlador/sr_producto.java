...
public class sr_producto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            producto = new Producto(request.getParameter("producto"),Integer.valueOf(request.getParameter("drop_marca")),Integer.valueOf(request.getParameter("txt_id")),request.getParameter("txt_descripcion"),Integer.valueOf(request.getParameter("txt_precio_costo")),Integer.valueOf(request.getParameter("txt_precio_venta")),Integer.valueOf(request.getParameter("txt_existencia")));
